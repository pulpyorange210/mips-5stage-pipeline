module ID_EX (
    ...
    // Data in
    input  wire [31:0] pc_plus4_in, rs_data_in, rt_data_in, sign_ext_imm_in,
    ...
    // Data out
    output reg  [31:0] pc_plus4_out, rs_data_out, rt_data_out, sign_ext_imm_out,
    ...
    always @(posedge CLK) begin
        if (reset || flush) begin
            ...
            pc_plus4_out <= 32'd0; rs_data_out <= 32'd0; rt_data_out <= 32'd0; sign_ext_imm_out <= 32'd0;
            ...
            ALUOp_out <= ALUOp_in;
            pc_plus4_out <= pc_plus4_in; rs_data_out <= rs_data_in; rt_data_out <= rt_data_in;

module ID_EX (
    ...
    // Data in
    input  wire [31:0] rs_data_in, rt_data_in, sign_ext_imm_in,
    ...
    // Data out
    output reg  [31:0] rs_data_out, rt_data_out, sign_ext_imm_out,
    ...
    always @(posedge CLK) begin
        if (reset || flush) begin
            ...
            rs_data_out <= 32'd0; rt_data_out <= 32'd0; sign_ext_imm_out <= 32'd0;
